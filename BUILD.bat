...
mkdir "artifacts"
mkdir "artifacts\windows-server"
mkdir "artifacts\windows-pos-app"
mkdir "artifacts\android"
mkdir "artifacts\_staging"
...
copy /y "build\app\outputs\flutter-apk\app-release.apk" "..\..\artifacts\android\findupto_pos_mobile.apk" >nul || exit /b 1
...
rmdir /s /q "artifacts\_staging" >nul 2>nul
exit /b 0
